...
namespace Dnet.Blazor.Infrastructure.Forms
{
    ...
    /// </summary>
    public abstract class DnetInputBase<TValue> : ComponentBase, IDisposable
    {
        ...
        protected string CssClass
        {
            get
            {
                ...
                return DnetAttributeUtilities.CombineClassNames(AdditionalAttributes, fieldClass);
            }
        }
